...
// (function(){
// 	const user = 'Teena';
// 	console.log(user); //Will print Teena. The second curly braccets we used is for calling the function
// 	const hello = () => console.log('Hello world');
// 	hello();
// })();

// hello(); //That will give us an error because the function hello() only exists in the scope of our IIFE.
